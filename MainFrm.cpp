...
if(Comport==INVALID_HANDLE_VALUE)
        {
        MessageBox(NULL,"Ошибка открытия порта","OH FUCK!!!",MB_ICONSTOP);
        return;
        }
...
{
        MessageBox(NULL,"Порт не открыт!","FUCK ACHTUNG!",MB_ICONSTOP);
        return;
}
...
{
        MessageBox(NULL,"Порт не закрыт!","ACHTUNG!! UVAGA!!!",MB_ICONSTOP);
        return;
}
